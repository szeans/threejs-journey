...
gui.add(waterMaterial.uniforms.uBigWavesElevation, 'value').min(0).max(1).step(.001).name('Big Waves Elevation')
gui.add(waterMaterial.uniforms.uBigWavesFrequency.value, 'x').min(0).max(10).step(.001).name('Big Waves Frequency X')
gui.add(waterMaterial.uniforms.uBigWavesFrequency.value, 'y').min(0).max(10).step(.001).name('Big Waves Frequency Z')
gui.add(waterMaterial.uniforms.uBigWavesSpeed, 'value').min(0).max(4).step(.001).name('Big Waves Speed')
